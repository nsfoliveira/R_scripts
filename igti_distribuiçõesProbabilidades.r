...
va_binomialmil <- rbinom(n = 1000, size=10, prob=0.5) 
hist(va_binomialmil) 
...
# Exemplo: Uma loja recebe em média, 6 (𝝺) clientes por minuto. Qual a probabilidade de que 5(x)
#clientesnentrem em um minuto?
